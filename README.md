...
[![MIT](https://flat.badgen.net/github/license/MIMBCD-UI/dataset-uta7-time)](https://github.com/MIMBCD-UI/dataset-uta7-time/blob/master/LICENSE)
...
[![HitCount](http://hits.dwyl.io/MIMBCD-UI/dataset-uta7-time.svg)](http://hits.dwyl.io/MIMBCD-UI/dataset-uta7-time)
...
```
git clone git@github.com:MIMBCD-UI/dataset-uta7-time.git
```

1.2. Go inside the project folder:

```
cd dataset-uta7-time/
```
...
For more information about the [MIMBCD-UI](https://MIMBCD-UI.github.io/) project just follow the [link](https://github.com/MIMBCD-UI/meta). Pieces of information about details of this *dataset* are also in a [wiki](https://github.com/MIMBCD-UI/dataset-uta7-time/wiki).
